...
";
        public static void Execute()
        {
            ...
            int maxX = 0;
            int maxY = 0;
            List<(string direction, int index)> folds = new List<(string direction, int index)>();
            List<(int, int)> points = new List<(int, int)>();
            ProcessData(lines, ref maxX, ref maxY, folds, points);
            bool[,] data = new bool[maxX + 1, maxY + 1];
            ...
            {
                var folded = fold(points, f.direction, f.index);
              //  ShowDataL(folded);
                points = folded;
            }
            ShowDataL(points);
